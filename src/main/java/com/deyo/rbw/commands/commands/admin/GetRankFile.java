...
implements ServerCommand {
    ...
    public void doCMD(String[] args2, Guild g2, Member m3, MessageChannelUnion c, CommandAdapter msg, String usage) {
        if (args2.length == 2) {
            ...
            if (target != null) {
                BetterEmbed success = new BetterEmbed("success", "", "", "Here's the rank file", "");
                success.reply(msg);
                c.sendFiles(FileUpload.fromData(new File("RBW/ranks/" + ID2 + ".yml"))).queue();
            } else {
